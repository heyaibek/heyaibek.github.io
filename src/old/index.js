    ...
    <div className="app">
      <div className="header">
        ...
        <div className="bio">
          ...
          <p>
            I'm a Software Engineer at <a href="https://spotify.com/">Spotify</a>.
          </p>
          <p>
            I also created <a href="https://chksnd.app">ChkSnd</a>.
          </p>
          <p>
            In my free time I produce electronic <a href="https://soundcloud.com/brakata">music</a>.
          </p>
        </div>
      </div>
        ...
        <div className="projects">
          <div className="project">
            ...
            <p className="description">
              ChkSnd is an app to create music
              <br />
              videos with a visual audio spectrum.
              <br />
              <br />
              Available for iOS and Android.
            </p>
            <a className="website" href="https://chksnd.app">
              Website
            </a>
          </div>
        </div>
